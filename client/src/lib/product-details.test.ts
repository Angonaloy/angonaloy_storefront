...
test("curates detailed source content for regular products", () => {
  const cases = [
    ...
    {
      slug: "honey-nut",
      labels: ["বিবরণ", "উপাদানসমূহ", "সম্ভাব্য উপকারিতা", "খাওয়ার সময় ও নিয়ম", "কেন আঙ্গনালয়ের?", "সংরক্ষণের নিয়ম"],
      expected: ["কাজু বাদাম", "কাঠবাদাম", "মধু"],
      minimumCharacters: 2150,
    },
    {
      slug: "chia-seed",
      labels: ["বিবরণ", "উপাদানসমূহ", "সম্ভাব্য উপকারিতা", "খাওয়ার সময় ও নিয়ম", "কেন আঙ্গনালয়ের?", "দৈনন্দিন খাদ্যতালিকায় ব্যবহার", "সংরক্ষণের নিয়ম"],
    ...
    },
    {
      ...
      labels: ["বিবরণ", "উপাদানসমূহ", "খাওয়ার সম্ভাব্য উপকারিতা", "খাওয়ার সময় ও নিয়ম", "কেন আঙ্গনালয়ের?", "সংরক্ষণের নিয়ম"],
      expected: ["আখের রস", "কার্বোহাইড্রেট", "আর্দ্রতা"],
      minimumCharacters: 1800,
    },
    {
      slug: "amsotto-pickle",
      labels: ["বিবরণ", "উপাদানসমূহ", "খাওয়ার উপকারিতা", "খাওয়ার সময় ও নিয়ম", "কেন আঙ্গনালয়ের?", "সংরক্ষণের নিয়ম"],
    ...
    {
      slug: "mustard-oil",
      labels: ["বিবরণ", "উপাদানসমূহ", "খাওয়ার সম্ভাব্য উপকারিতা", "ব্যবহারের নিয়ম", "কেন আঙ্গনালয়ের?", "সংরক্ষণের নিয়ম"],
    ...
    },
    {
      ...
      labels: ["বিবরণ", "উপাদানসমূহ", "সম্ভাব্য উপকারিতা", "কেন আঙ্গনালয়ের?", "সংরক্ষণের নিয়ম"],
    ...
    {
      slug: "katimon-mango",
      labels: ["বিবরণ", "বৈশিষ্ট্য", "সম্ভাব্য উপকারিতা", "খাওয়ার সময় ও নিয়ম", "কেন আঙ্গনালয়ের?", "সংরক্ষণের নিয়ম"],
      expected: ["কাটিমন", "অফসিজন", "কৃত্রিমভাবে পাকানো নয়"],
      minimumCharacters: 1700,
    },
    {
      slug: "homemade-pumpkin-bori",
      labels: ["বিবরণ", "বৈশিষ্ট্য", "উপকরণ", "রান্নার পরামর্শ", "সংরক্ষণের নিয়ম", "কেন আঙ্গনালয়ের?"],
