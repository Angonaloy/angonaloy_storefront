...
test("renders a slightly shorter edge-to-edge Angonaloy hero on mobile", () => {
  ...
  assert.match(homeSource, /className="relative z-10 aspect-\[940\/1000\] w-full overflow-hidden rounded-none border border-black\/10 bg-white md:aspect-auto md:min-h-\[600px\] md:rounded-\[6px\]"/);
